...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-pkg_resources-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13130&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-pkg_resources-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-pkg_resources` can be installed with:

```
conda install types-pkg_resources
```

It is possible to list all of the versions of `types-pkg_resources` available on your platform with:
